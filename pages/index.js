...
const Home = () => {
  ...
  return (
    <Box
      ...
      p={40}
    >
      <TitleAndText variant={'title1'} mb={20} color={yourChoiceLOrD.tc}>
        lista ulubionych potraw
      </TitleAndText>
      <TitleAndText variant={'title2'} mb={20} color={yourChoiceLOrD.tc}>
        na liście jest
        <TitleAndText as="span" variant={'title1'}>
          {' '}
          {meals.length}{' '}
        </TitleAndText>
        pozycji
      ...
      <Box
        ...
        mt={40}
      >
        <ButtonLOrD yourChoiceLOrD={yourChoiceLOrD} onClick={lOrD.toggleLD}>
